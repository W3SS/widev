class WebservicesController < ApplicationController
  ...
  def import
      if( params[:file] )
          ...
          Webservice.import(params[:file])
          redirect_to webservices_path , notice: "Webservice imported."
      end
  end
  ...
  private
    ...
    def webservice_params
      params.require(:webservice).permit(:name, :int_endpoint, :bs, :bs_method, :applet, :applet_method, :description)
    end
end
