...
class WebservicesControllerTest < ActionController::TestCase
  ...
  test "should create webservice" do
    assert_difference('Webservice.count') do
      post :create, webservice: { applet: @webservice.applet, applet_method: @webservice.applet_method, bs: @webservice.bs, bs_method: @webservice.bs_method, description: @webservice.description, int_endpoint: @webservice.int_endpoint, name: @webservice.name }
    end
  ...
  test "should update webservice" do
    patch :update, id: @webservice, webservice: { applet: @webservice.applet, applet_method: @webservice.applet_method, bs: @webservice.bs, bs_method: @webservice.bs_method, description: @webservice.description, int_endpoint: @webservice.int_endpoint, name: @webservice.name }
    assert_redirected_to webservice_path(assigns(:webservice))
  end
